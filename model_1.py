...
pickle_in_1=open("/result/x_train_file.pickle","rb")
x_train=pickle.load(pickle_in_1)

pickle_in_2=open("/result/x_test_file.pickle","rb")
x_test=pickle.load(pickle_in_2)

pickle_in_3=open("/result/y_train_file.pickle","rb")
y_train=pickle.load(pickle_in_3)

pickle_in_4=open("/result/y_test_file.pickle","rb")
